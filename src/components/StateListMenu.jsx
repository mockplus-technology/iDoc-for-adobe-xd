          ...
          <div
            ...
            onClick={() => {
              if( childItem._id === selectItem._id){
                this.setState({   selectItem: { id: "", name: "" },
                defaultName: "",})
              }else{
            ...
            onDoubleClick={() => {
              this.setState({ visible: true,imgSrc:childItem.imageURL });
            }}
          >
            <img src={childItem.imageURL} className="state_img" />
            {childItem.name}
          </div>
        ))}
      </div>
      ...
      <div className="content">
        ...
        <div>
          ...
          <RadioGroup
            ...
            items={[
              { text: i18n("multiStatus.overridePageRadio"), value: "cover" },
              { text: i18n("multiStatus.newStatusPageRadio"), value: "add" }
            ]}
            onChange={value => {
          ...
          <button
            className="upload_state_img_btn"
            onClick={this.onUploadStateImg}
          >
